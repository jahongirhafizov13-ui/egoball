...
function quickPlayWithFriends(mode, friendNames){
  ...
  myId = socket.id; // set BEFORE emitting - see joinLocalServer (hub-multiplayer.js) for why
...
document.getElementById('btnOpenAvatarShop').addEventListener('click', ()=> AvatarShopModule.open());
